...
import convertMe from '@/public/pojects_images/convertMe.svg'
            ...
            <div className='px-4 pb-[80px]'>
                <div className='max-w-[1180px] mx-auto flex flex-col gap-8 max-xl:max-w-[900px] max-lg:max-w-[700px]'>
                    ...
                    <div className='flex flex-col gap-8'>
                        ...
                        <div className='flex justify-between max-xl:gap-4 max-lg:flex-col'>
                            <div className='flex items-start gap-6 border border-solid border-stone-200 rounded-xl w-max pt-[24px] pr-[46px] pb-[21px] pl-[24px] max-xl:pr-[24px] max-lg:w-full max-md:p-[12px] cursor-pointer' onClick={redirectConvertMe} style={{backgroundColor: '#18181B'}}>
                                <Image src={convertMe} alt='subscribe image'  
                                    className='border border-solid border-stone-200 rounded-lg max-sm:w-[140px] max-sm:h-[160px] max-sm:object-cover'
                                />
                                <div className='flex flex-col gap-6'>
                                    <div className='flex flex-col gap-3'>
                                        ...
                                        <div className='flex flex-col gap-1'>
                                            <p className='text-sm ' style={{color: '#A1A1AA'}}>React js, Api Rest</p>
                                            <h2 className='font-semibold text-base text-white'>ConvertMe</h2>
                                        </div>
                                    </div>
                                    <p className='max-w-[241.25px] text-sm' style={{color: '#D4D4D8'}}>Un convertisseur de devises avec des taux d'echanges mis a jour en temps reel via une api</p>
