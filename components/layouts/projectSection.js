    ...
    return(
        <>
            <div className='px-6 pb-[80px]'>
                <div className='max-w-[1180px] mx-auto flex flex-col gap-8 max-xl:max-w-[900px]'>
                    <div className="flex flex-col gap-2">
                        <h1 className='text-2xl font-bold'>My Projects</h1>
                        <p>Voici une petite liste des projets que j'ai réalisé et auxquels j'ai participé.</p>
                    </div>
                    <div className='flex flex-col gap-8'>
                        <div className='flex justify-between max-xl:gap-4'>
                            <div className='flex items-start gap-6 border border-solid border-stone-200 rounded-xl w-max pt-[24px] pr-[46px] pb-[21px] pl-[24px] max-lg: pr-[24px]'>
                                <Image src={subscribe} alt='subscribe image'  
                                    className='border border-solid border-stone-200 rounded-lg'
                                />
